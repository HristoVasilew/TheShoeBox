...
mailing envelopes.
', 349,
        'https://images.vans.com/is/image/Vans/VC0836-HERO?$CUSTOMS-PDP-LARGE$' ,2, '2021-11-30 11:31:39');
INSERT INTO shoes(id, brand, model, size, shoe_condition_entity_id, shoe_category_entity_id, location, description, price, image_url,creator_id, created_on)
VALUES (3, 'Vans', 'Old Scool', 35, 2, 4, 'ulica геросаоо Sao Paolo 33 N2 122',
        ', including past and present branding, a vintage U.S. Mail logo and patch,
            ...
            ', 249,
        'https://images.vans.com/is/image/Vans/VC0847-HERO?$CUSTOMS-PDP-LARGE$' ,2, '2021-11-30 11:31:39');
INSERT INTO shoes(id, brand, model, size, shoe_condition_entity_id, shoe_category_entity_id, location, description, price, image_url,creator_id, created_on)
